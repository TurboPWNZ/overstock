    ...
    private static function setAdsPhoto($data) {
        if (isset($data["callback_query"])) {
            ...
            if ($action == "/publish_ads") {
                ...
                self::$_responseMessage = "Обери бажаний варіант публікації: \n\n
- 🆓Безкоштовно - 1 публікація оголошення на день\n
- 💵20 грн - 3 публікації оголошення на день\n
- 💵50 грн - 10 публікацій оголошення на день\n";
